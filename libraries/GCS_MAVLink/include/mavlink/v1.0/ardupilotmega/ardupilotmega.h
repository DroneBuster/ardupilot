...
typedef enum MAV_CMD
{
	...
	MAV_CMD_OT_PARACHUTE=211, /* Mission command which control parachute |Enable FS (0=disable, 1=enable)| Land immediately(0=not, 1=land| Set ignition(0=off, 1=on)| Set Parachute servo(0=closed, 1=open)| Empty| Empty| Empty|  */

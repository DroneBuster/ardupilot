...
typedef enum MAV_CMD
{
	...
	MAV_CMD_OT_PARACHUTE=214, /* Mission command which control parachute |Enable FS (0=disable, 1=enable)| Land immediately(0=not, 1=land| Set ignition(1=off, 0=on)| Set Parachute servo(0=closed, 1=open)| Empty| Empty| Empty|  */
